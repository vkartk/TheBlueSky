...
import { createPassenger, fetchPassengers, updatePassenger } from '@/features/passenger/passengerThunks';
    ...
    return (
        <div className="container mx-auto p-8">
            <header className="flex items-center justify-between mb-6">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">All Passengers</h1>
                    <p className="text-muted-foreground">View and manage all passenger records in the system.</p>
                </div>
